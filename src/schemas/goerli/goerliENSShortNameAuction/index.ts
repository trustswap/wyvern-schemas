...
export const GOERLI_ENS_SHORT_NAME_AUCTION_ADDRESS =
  '0x76b6481a334783be36f2fc35b8f0b9bc7835d57b';

export const goerliENSShortNameAuctionSchema: Schema<ENSName> = {
  ...ENSNameBaseSchema,
  version: 0,
  ...
  functions: {
    transfer: ({ name }) => ({
      ...
      target: GOERLI_ENS_SHORT_NAME_AUCTION_ADDRESS,
      inputs: [
        {
